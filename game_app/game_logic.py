...
class Game:
    ...
    ACTION_VERBOSE_DESCRIPTIONS = {
        ...
        'defend_shield': "Applies a temporary shield to a line, making it immune to one standard attack. If all lines are shielded, it overcharges an existing shield to extend its duration.",
